...
const collection = "sys_user_roles";//use this parameter to check permissions: save, select, delete.... 
...
const pageTitleIndex = 'sys_user_roles Management';
	...
	addRole: async function (req, res, next) {
		...
		if(error){
			...
			if(checkAlreadyExists == false){
				...
				res.status(200).send({status:200, success : false, item, message:"RoleAlreadyExists"})	
			}
